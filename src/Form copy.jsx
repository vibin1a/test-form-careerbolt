  ...
  const [data_to_send_to_backend,set_data_backend]=useState({
    ...
    const handleUpload=(e)=>{
      ...
      reader.onloadend=()=>{
        ...
        fetch("https://1ne5t0gxdk.execute-api.ap-south-1.amazonaws.com/V1/company-info-update",{
            method: "PUT",
            headers: {
      ...
      //console.log("image type",data_to_send_to_backend.image)
